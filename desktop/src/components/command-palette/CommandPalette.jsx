...
export default function CommandPalette({ isOpen, onClose, onNavigate, onAction, currentTab, isDark, onToggleTheme }) {
  ...
  useEffect(() => {
    ...
    // Load files
    apiFetch('/api/files?path=workspace')
      .then(r => r.json())
      ...
      <div className="w-full max-w-2xl bg-card border border-border rounded-xl shadow-2xl overflow-hidden flex flex-col max-h-[70vh]">
        ...
        <div className="flex items-center gap-3 px-4 py-3 border-b border-border">
          ...
          <input
            ...
            spellCheck="false"
          />
          <kbd className="hidden sm:inline-flex items-center gap-1 px-1.5 py-0.5 rounded bg-surface border border-border text-[10px] text-muted-foreground font-mono">
        ...
        {/* Footer */}
        <div className="px-4 py-2 border-t border-border bg-surface/50 flex items-center gap-4 text-[10px] text-muted-foreground">
