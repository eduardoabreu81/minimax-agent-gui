...
export const THEMES = [
  ...
  { id: 'forest', name: 'Forest', color: 'bg-green-500', preview: { lightBg: '#f0fdf4', lightText: '#16a34a', darkBg: '#052e16', darkText: '#4ade80' } },
  ...
  { id: 'minimax', name: 'MiniMax', color: 'bg-red-500', preview: { lightBg: '#fef2f2', lightText: '#dc2626', darkBg: '#450a0a', darkText: '#f87171' } },
